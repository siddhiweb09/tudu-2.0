...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2025 at 03:45 PM
...
--
-- Table structure for table `delegated_tasks`
--

CREATE TABLE `delegated_tasks` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `task_id` varchar(255) NOT NULL,
  `delegate_task_id` varchar(255) NOT NULL,
...
(4, '2025_06_21_083429_create_all_table', 2);
...
('xHUNXPKBldgmuOyDLHBOyfKMImKNXApKyLv63O0T', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiTHMzV0tSVHNrMTRWSkVOOEZDdEJYeXM5WTBhZUVxZzhPdzBESTZiaiI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1750509221);
...
--
-- Table structure for table `task_medias`
--
...
--
-- Indexes for table `delegated_tasks`
--
...
--
-- Indexes for table `task_medias`
--
ALTER TABLE `task_medias`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `delegated_tasks`
--
ALTER TABLE `delegated_tasks`
...
--
-- AUTO_INCREMENT for table `task_medias`
--
ALTER TABLE `task_medias`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
