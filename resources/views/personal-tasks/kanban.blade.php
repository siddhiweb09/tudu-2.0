...
<script>
    ...
    $(document).ready(function() {
        ...
        window.initializeDragAndDrop = function() {
            ...
            const freshCards = document.querySelectorAll('.kanban-card');
            const freshColumns = document.querySelectorAll('.kanban-column');
        ...
        function updateTaskStatus(card) {
            ...
            if (column.id === 'todo-column') newStatus = 'Pending';
            else if (column.id === 'inprogress-column') newStatus = 'in-progress';
            else if (column.id === 'completed-column') newStatus = 'completed';
            else if (column.id === 'overdue-column') newStatus = 'overdue';
            ...
            $.ajax({
                ...
                success: () => fetchTasks() // Refresh after update
            });
        }
        ...
        function renderTasks(tasks) {
            ...
            tasks.forEach(task => {
                ...
                const taskHtml = `<div class="kanban-card ${borderColourClass}" draggable="true" data-task-id="${task.task_id}">
    ...
    //                         overdueCount++;
    //                     }
    //                     let taskHtml = `<div class="kanban-card ${borderColourClass}" draggable="true" data-task-id="${task.task_id}>
    //                                         <div class="kanban-card-header d-flex justify-content-between">
    //                                             <span>${task.title}</span>
    //                                             <div class="dropdown" style="position: static;">
    //                                                 <button type="button" 
    //                                                         class="kanban-dropdown-btn" 
    //                                                         data-bs-toggle="dropdown" 
    //                                                         aria-expanded="false">
    //                                                     <i class="bi bi-three-dots-vertical"></i>
    //                                                 </button>
    //                                                 <div class="kanban-dropdown-menu dropdown-menu dropdown-menu-end p-2">
    //                                                     <div class="d-flex gap-2 justify-content-center">  <!-- Flex container for side-by-side buttons -->
    //                                                         <button class="kanban-icon-btn kanban-edit-btn" 
    //                                                                 title="Edit"
    //                                                                 aria-label="Edit task">
    //                                                             <i class="bi bi-pencil-square"></i>
    //                                                         </button>
    //                                                         <button class="kanban-icon-btn kanban-delete-btn" 
    //                                                                 title="Delete"
    ...
    //             } else {
    //                 $('#todo-tasks').html('<p class="text-danger">No tasks found.</p>');
    //                 $('#inProgress-tasks').html('<p class="text-danger">No tasks found.</p>');
    //                 $('#completed-tasks').html('<p class="text-danger">No tasks found.</p>');
    //                 $('#overdue-tasks').html('<p class="text-danger">No tasks found.</p>');
    //             }
    //         },
    //         error: function() {
    //             $('#todo-tasks').html('<p class="text-danger">Error loading tasks.</p>');
    //             $('#inProgress-tasks').html('<p class="text-danger">Error loading tasks.</p>');
    //             $('#completed-tasks').html('<p class="text-danger">Error loading tasks.</p>');
    //             $('#overdue-tasks').html('<p class="text-danger">Error loading tasks.</p>');
    //         }
    //     });
    // });
</script>
