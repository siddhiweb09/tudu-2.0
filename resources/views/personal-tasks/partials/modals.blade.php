...
<div class="modal fade" id="taskDetailModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header primary-gradient-effect text-white py-4">
                <div class="d-flex align-items-center">
                    <div class="icon-circle bg-white-10 me-3">
                        <i class="ti ti-clipboard-text fs-1 text-white"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold mb-0" id="assignTaskModalLabel">TASK DETAILS</h5>
                        <p class="text-white-80 mb-0 small" id="detail-title"></p>
                    </div>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="notes-description card mb-4 ">
                    <div class="card-header bg-light select-card-header">
                        <h5 class="mb-0"><i class="ti ti-article me-2"></i>Description </h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="task-meta card mb-4 ">
                    <div class="card-header bg-light select-card-header">
                        <h5 class="mb-0"><i class="ti ti-file-info me-2"></i>Info </h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="meta-item mb-3">
                                    <strong><i class="ti ti-square-check me-2 mt-1 fs-5"></i>Status:</strong>
                                    <span id="detail-status" class="badge ms-2"></span>
                                </div>
                                <div class="meta-item mb-1">
                                    <strong><i class="ti ti-alert-square-rounded me-2 fs-5"></i>Priority:</strong>
                                    <span id="detail-priority" class="badge ms-2"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="meta-item mb-3">
                                    <strong><i class="ti ti-calendar me-2 fs-5"></i>Due Date:</strong>
                                    <span id="detail-due-date" class="ms-2"></span>
                                </div>
                                <div class="meta-item mb-1">
                                    <strong><i class="ti ti-tag me-2 fs-5"></i>Category:</strong>
                ...
                <div class="notes-section card ">
                    <div class="card-header bg-light select-card-header">
                        <h5 class="mb-0"><i class="ti ti-message-2 me-2"></i>Notes</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="addNoteForm" class="mt-4">
                            ...
                            <div class="mb-3">
                                <textarea class="form-control" name="note" placeholder="Add a note or reflection..."
                                    rows="3" required></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary w-100">
                                <i class="ti ti-message-2-plus me-1"></i> Add Note
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="documents-section card mt-4 ">
                    <div class="card-header bg-light select-card-header">
                        <h5 class="mb-0"><i class="ti ti-file-text me-2"></i>Documents</h5>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3 new-category-group" style="display: none;">
                                ...
                                <input type="text" class="form-control" id="edit_new_category_name"
                                    name="new_category_name">
                                <label for="edit_new_category_color" class="form-label">Color</label>
                                <input type="color" class="form-control form-control-color" id="edit_new_category_color"
                                    name="new_category_color" value="#3f51b5">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="edit_time_estimate" name="time_estimate"
                                    min="0" step="5">
                            </div>

                            <div class="form-check mb-3">
                                <input type="checkbox" class="form-check-input" id="edit_is_habit" name="is_habit">
                                <label class="form-check-label" for="edit_is_habit">This is a habit/recurring
                                    task</label>
                            </div>
                                        ...
                                        <div class="select-card active-on-hover">
                                            ...
                                            <div id="frequency_section_form" class="p-3">
                                                ...
                                                <div id="additional_fields_form1"
                                                    ...
                                                    <p class="m-0 small mt-3"><b>Note: </b><span class="note"></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
