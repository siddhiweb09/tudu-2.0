      ...
      <div class="col-lg-6 d-none d-lg-block p-0">
        ...
        <div id="loginCarousel" class="carousel slide h-100 w-100" data-bs-ride="carousel">
          ...
          <div class="carousel-item active">
            <img src="{{ asset('assets/images/login1.jpg') }}" class="d-block w-100 img-fluid object-fit-cover"
            style="height: 100vh;" alt="Slide 1">
          </div>

          <div class="carousel-item">
            <img src="{{ asset('assets/images/login2.jpg') }}" class="d-block w-100 img-fluid object-fit-cover"
            style="height: 100vh;" alt="Slide 2">
          </div>

          <div class="carousel-item">
            <img src="{{ asset('assets/images/login3.jpg') }}" class="d-block w-100 img-fluid object-fit-cover"
            style="height: 100vh;" alt="Slide 3">
          </div>
