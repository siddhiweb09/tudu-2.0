                                        ...
                                        <div id="additional_fields_form1" class="p-4 bg-light border-top d-none">
                                            <div id="weekly_days_form1" class="frequency-option mb-3 d-none">
                                                ...
                                                <div class="day-picker">
                                                    <input type="checkbox" id="sunday_form1" name="frequency_duration[]"
                                                        value="Sunday" class="day-checkbox">
                                                    <label for="sunday_form1" class="day-label">S</label>

                                                    <input type="checkbox" id="monday_form1" name="frequency_duration[]"
                                                    ...
                                                    <input type="checkbox" id="friday_form1" name="frequency_duration[]"
                                            ...
                                            <div id="yearly_date_form1" class="frequency-option d-none">
                                                ...
                                                <input type="date" class="form-control" id="yearly_date_input_form1"
                                            ...
                                            <div id="periodic_frequency_form1" class="frequency-option d-none">
                                                ...
                                                <input type="number" class="form-control" id="periodic_interval_form1"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            id="occurs_every_dropdown_form1" name="frequency_duration[]"
                                                            min="1" placeholder="Interval Count of Week/Month">
                                                    </div>
                                                </div>
                                            </div>
